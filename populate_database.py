...
user1 = Person(name='Paul', email='paul@gmail.com')
session.add(user1)
session.commit()
...
item2 = Item(title='Ex Machina',
             description="Caleb Smith (Domhnall Gleeson) a programmer, wins a contest that enables him to spend a week with CEO Nathan Bateman (Oscar Isaac).",
...
item8 = Item(title='This American Life',
             description="This American Life (TAL) is an American weekly hour-long radio program produced by WBEZ and hosted by Ira Glass. It is broadcast on numerous public radio stations in the United States.",
